...
let template =
    ...
    '                </div>' +
    '                <el-button type="primary" style="margin-left:10px" size="mini"' +
    '                   @click.stop.prevent="sendImgAction(\'remoteClipGrayscaleAndThresholdToServer\')">' +
    '                   图像处理(加载)' +
    '                </el-button>' +
    '                <el-button type="primary" style="margin-left:10px" size="mini"' +
    '                    @click.stop.prevent="sendImgAction(\'remoteClipGrayscaleAndThresholdAnalysisChartToServer\')">' +
    '                    文字识别' +
    '                </el-button>' +
