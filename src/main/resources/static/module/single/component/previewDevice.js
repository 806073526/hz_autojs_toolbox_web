...
$.ajax({
    url: "/module/single/template/previewDevice.html",
    type: 'get',
    async: false,
...
export default {
    ...
    methods: {
        ...
        init(){
            ...
            if (this.deviceInfo.deviceUuid) {
                // 处理宽度缓存
                this.previewImageWidth = window.localStorage.getItem("preview_"+this.deviceInfo.deviceUuid+"_previewImageWidth") || 100;
                // 处理消息推送渠道
